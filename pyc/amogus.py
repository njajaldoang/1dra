...
\033[0;36m                              
\033[0;36m =============Amogus CREATED THIS DDOS======================"""
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] AmogusTools | Api Connected [5] | Backup Server [1] | Online User [1000] | Admin: [Amogus] | POWER : {}% [UNSTABLE]\x07".format (powerran))
